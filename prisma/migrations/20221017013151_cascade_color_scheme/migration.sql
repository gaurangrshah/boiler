...
INSERT INTO "new_colorScheme" ("accent", "accentDark", "bg", "bgDark", "gray", "grayDark", "id", "preferenceId", "primary", "primaryDark", "secondary", "secondaryDark") SELECT "accent", "accentDark", "bg", "bgDark", "gray", "grayDark", "id", "preferenceId", "primary", "primaryDark", "secondary", "secondaryDark" FROM "colorScheme";
